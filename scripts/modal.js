$(document).ready(function() {
  ...
  var modalText = {
    discover: {
      ...
      detail:
      'Offer a Wide Range of Products: Offer a variety of furniture styles, designs, and price ranges to cater to different customer preferences. '  , 
      link: '#'
    },
    ordering: {
    ...
    walker: {
      title: 'vegetable store Web',
      tag: 'The easiest way to order vegetables.',
      detail:
        'Easy and free site to order vegetables.',
    },
    powur: {
      title: 'amad furniture',
      tag: 'to order onine  furniture.',
      detail:
        '.',
